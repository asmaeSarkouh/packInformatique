...
<div class="flex justify-between items-center mb-3 px-4 py-2 border-b">
    <h2 class="text-2xl font-bold leading-tight mb-3 text-gray-800"> Create un Material</h2>
</div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" value="<?php echo e(old('dateLivrision')); ?>" id="dateLivrision" name="dateLivrision" 
                    ...
                    <div class="mb-6">
                        ...
                        dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                          <option>select type</option>
                           <option value="Direction"  <?php if( old('lieu')  == 'Direction'): ?> selected="selected" <?php endif; ?>>Direction</option>
                           <option value="Bibliotheque"  <?php if( old('lieu')  == 'Bibliotheque'): ?> selected="selected" <?php endif; ?>>Bibliotheque</option>
                           <option value="SMM"  <?php if( old('lieu')  == 'SMM'): ?> selected="selected" <?php endif; ?>>SMM</option>
                           <option value="Salle de eouvr"  <?php if( old('lieu')  == 'Salle de eouvr'): ?> selected="selected" <?php endif; ?>>Salle de eouvr</option>
                           <option value="Labo"  <?php if( old('lieu')  == 'Lab'): ?> selected="selected" <?php endif; ?>>Labo</option>
                          </select>
                        </div>
                    </div>
                ...
                <div class="mt-2">
                  ...
                  <option>select type</option>
                    ...
                    <option value="<?php echo e($type->id); ?>"
                        <?php if( old('type_id')  == $type->id): ?> selected="selected" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group" id="myInputDiv" style="display:none">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="probleme" value="<?php echo e(old('probleme')); ?>" id="probleme" name="probleme" type="text"  
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                        focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                        dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\azer\Desktop\laravel\formation_continue\resources\views/page/material/create.blade.php ENDPATH**/ ?>